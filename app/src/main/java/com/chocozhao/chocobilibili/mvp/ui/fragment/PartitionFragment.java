...
import com.chocozhao.chocobilibili.di.component.DaggerPartitionComponent;
import com.chocozhao.chocobilibili.mvp.contract.PartitionContract;
import com.chocozhao.chocobilibili.mvp.presenter.PartitionPresenter;
 ...
 * ================================================
 */
public class PartitionFragment extends BaseFragment<PartitionPresenter> implements PartitionContract.View {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerPartitionComponent //如找不到该类,请编译一下项目
                .builder()
